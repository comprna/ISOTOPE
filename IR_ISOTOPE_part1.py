...
parser.add_argument("-introns_normal", "--introns_normal", required=True, help = "transcript expression to introns on normal controls")
parser.add_argument("-introns_GTEX", "--introns_GTEX", required=True, help = "transcript expression to introns on GTEX samples")
