...
def select_fasta_candidates(input_list_path, input_sequence_path, output_sequence_path, output_sequence_pieces_path):
    ...
    try:
        ...
        # input_list_path = "/projects_rg/SCLC_cohorts/cis_analysis/v5/SCLC_v5/tables/IR_ORF_filtered_peptide_change.tab"
        # input_sequence_path = "/projects_rg/SCLC_cohorts/cis_analysis/v5/SCLC_v5/tables/IR_peptide_sequence.fa"
        # output_sequence_path = "/projects_rg/SCLC_cohorts/cis_analysis/v5/SCLC_v5/tables/IR_peptide_sequence_filtered.fa"
        # output_sequence_pieces_path = "/projects_rg/SCLC_cohorts/cis_analysis/v5/SCLC_v5/tables/IR_fasta_files"
        ...
        with open(input_list_path) as f:
            ...
            for line in f:
                ...
                New_Exon_pos = header.index("Event_id")
