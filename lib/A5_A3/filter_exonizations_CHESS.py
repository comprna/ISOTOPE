...
filter_neoskipping_CHESS: from our list of A5_A3, we are gonna check if this events appears in the CHESS
...
def filter_exonizations_CHESS(exonization_path, CHESS_A5_path, CHESS_A3_path, output_path):
    ...
    try:
        ...
        if(CHESS_A5_path!="Missing" | CHESS_A3_path!="Missing"):
            ...
            # If CHESS path missing, just return the same file
            shutil.copyfile(output_path + "/non_mutated_exonizations_filtered.tab",
