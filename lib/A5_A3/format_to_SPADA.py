        ...
        with open(input_path1) as f:
            ...
            for line in f:
                ...
                if(tokens[peptide_change_pos]=="True" and tokens[NMD_pos]=="False"):
                    ...
                    junction_ID = tokens[can_exon_pos]+"|"+tokens[alt_exon_pos]
                    ...
                    #Save the values
                    # output_file.write(sample_ID+"\tSCLC\t"+gene+"\t"+junction_ID+"\t"+transcript+"\t"+reference+"\t"+alternative+"\n")
                    output_file1.write(gene+"\t"+transcript+"\t"+junction_ID+"\t"+sample_ID+"\n")
                    output_file2.write(">"+transcript+"\n")
                    output_file2.write(reference+"\n")
                    output_file2.write(">"+junction_ID+"\n")
